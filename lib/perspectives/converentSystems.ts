...
export const converentSystems: Perspective = {
  ...
  content: [
    ...
    "The real cost of requirements is not process - it is language.",
    "Requirements are:",
    "Textual",
    "Normative",
    ...
    "Expected to mean the same thing to every stakeholder",
    "That is an extraordinarily high bar for humans to adhere to when managing hundreds or thousands of objects.",
    ...
    "How many times have engineers left the meeting with decisions made that weeks or months later manifest in a curious set of similar but slightly different decisions?",
    ...
    "What is often missing from that conversation is this:",
    "The same teams blaming requirements rarely reviewed them properly in the first place.",
    "They did not challenge ambiguity.",
    "They did not enforce consistency.",
    "They did not validate traceability.",
    "They did not revisit intent as the system evolved.",
    ...
    "Requirements do not just grow in number; they grow in interdependence. Emergent behavior, cross-domain coupling, and safety interactions quickly outpace what any individual - or isolated agile team - can reason about locally.",
    ...
    "Retrofitting intent after implementation",
    "This works - until it does not.",
    "At scale, complexity overwhelms intuition. Traditional, human-centric requirements practices simply stopped keeping up.",
    "In that sense, requirements did not die because they were wrong.",
    "They died because humans could not manage them anymore.",
    ...
    "The technology changed. The humans did not.",
    "So why would the outcome be different?",
    "Spec-Driven Development Is the Real Shift",
    "The real change is not AI writing requirements.",
    "It is spec-driven development.",
    "As code generation becomes increasingly automated, the developer role shifts. Writing implementation code becomes less central as generation and synthesis improve.",
    "What replaces it is not chaos, but clarity:",
    "Clear specifications",
    "Clear intent",
    "Clear, unambiguous statements of what is required",
    ...
    "This aligns naturally with test-driven development. As specifications become executable and verifiable, tests are automatically derived from specs, and implementation is progressively absorbed into tooling.",
    ...
    "Requirements guide generation (implementation)",
    "Requirements define verification",
    "Requirements anchor traceability",
    "Requirements protect intent from drift",
    ...
    "How intent is decomposed",
    "How correctness is proven",
    "How deviations are prevented",
    "That someone is not a coding assistant.",
    "It is systems engineering.",
    "What This Means for Teams Building Real Systems",
    "I see this shift already well underway and gathering momentum.",
    "Not in the hype cycles around AI tooling, but in the quiet realization many teams are coming to: complex systems do not fail because teams cannot build fast enough - they fail because intent is lost.",
    ...
    "From implementation-led to intent-led development",
    "From reactive defect fixing to verification-driven confidence",
    "From fragmented, misunderstood agility to system-level clarity and control",
    "The resurgence of requirements is not about returning to the past.",
    "It is about building systems that survive the future.",
